# goCalc-v2 - Распределенный Калькулятор с Аутентификацией
...
**goCalc-v2** - это эволюция распределенного калькулятора, реализованного на языке Go. Эта версия добавляет:
